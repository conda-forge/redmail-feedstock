...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/redmail-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15063&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/redmail-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `redmail` can be installed with:

```
conda install redmail
```

It is possible to list all of the versions of `redmail` available on your platform with:
